 ...
 * CONSTANTS
 **************/
const colors: {[k:string]: (offset?:number) => any} = {}
...
const zIndexes = createRange([1, 10, 1000, 1010, 1030, 1050], 1)
const borderRadius = createRange([2, 4], 0)

const PRIMARY_COLOR = 'axii'

export { colors, fontSizes, spaceValues, PRIMARY_COLOR, lineHeightValues, maskColors, zIndexes, shadows, fontWeights, borderRadius }
