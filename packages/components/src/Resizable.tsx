import {atom, Component, FixedCompatiblePropsType, PositionObject, PropsType, PropTypes, RenderContext} from "axii";
...
export const Resizable: Component = function(props: FixedCompatiblePropsType<typeof PopoverPropTypes>, { createElement, createPortal, context, createRef, createStateFromRef}: RenderContext) {
