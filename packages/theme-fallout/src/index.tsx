...
export function install() {
        ...
        return {
            '$root:style': () => {
                return {
                    ...
                    padding: 0,
                    overflow: 'hidden',
                    border: rxFocused.value() ? `1px solid ${colors.line.border.focused()}` : enclosedContainer.border
                }
            },
            '$main:style': {
                ...rawControl,
    ...
    document.head.appendChild(<link href="https://fonts.googleapis.com/css2?family=VT323&display=swap" rel="stylesheet"/> as HTMLElement)
